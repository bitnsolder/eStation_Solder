...
/* USER CODE BEGIN PFP */
extern uint16_t ntc_adc_raw[1]; // Buffer cho DMA
/* USER CODE END PFP */
...
int main(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_8, GPIO_PIN_RESET); // Ép xuống 0V
  /* USER CODE END 1 */
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, TFT_DC_Pin|TFT_CS_Pin|TFT_RST_X_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(TFT_BL_GPIO_Port, TFT_BL_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, LED_Pin|TFT_RST_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : TFT_DC_Pin TFT_CS_Pin TFT_BL_Pin TFT_RST_X_Pin */
  GPIO_InitStruct.Pin = TFT_DC_Pin|TFT_CS_Pin|TFT_BL_Pin|TFT_RST_X_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  ...
  /*Configure GPIO pin : STAND_INP_Pin */
  GPIO_InitStruct.Pin = STAND_INP_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(STAND_INP_GPIO_Port, &GPIO_InitStruct);
